...
my @pods = (
  "../man/RNAz.pod",           "../perl/rnazWindow.pl",
  "../perl/rnazOutputSort.pl", "../perl/rnazCluster.pl",
  "../perl/rnazSelectSeqs.pl", "../perl/rnazFilter.pl",
  "../perl/rnazSort.pl",       "../perl/rnazAnnotate.pl",
  "../perl/rnazBlast.pl",      "../perl/rnazCMsearch.pl",
  "../perl/rnazIndex.pl",      "../perl/rnazBEDsort.pl",
  "../perl/rnazBEDstats.pl",   "../perl/rnazMAF2BED.pl",
...
foreach my $pod (@pods) {
  ...
  while (<IN>) {
    # Change \textbf{--foo} to \textbf{-{}-foo} to avoid double dash ligature
    s/\{--/\{-\{\}-/g;
    $in .= $_;
  }
